...
@last_name = options['last_name'] 
  ...
  def save
    sql = 'INSERT INTO star (first_name, last_name) VALUES ($1, $2) RETURNING id'
  ...
  def update
    sql = 'UPDATE star SET (first_name, last_name) = ($1, $2) WHERE id = $3'
  ...
  def self.all
    sql = 'SELECT first_name, last_name FROM star'
